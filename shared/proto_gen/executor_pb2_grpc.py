...
class ExecutorServiceServicer:
    ...
    def EnqueueExecution(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_ExecutorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'EnqueueExecution': grpc.unary_unary_rpc_method_handler(
                    servicer.EnqueueExecution,
                    request_deserializer=executor__pb2.EnqueueRequest.FromString,
                    response_serializer=executor__pb2.EnqueueResponse.SerializeToString,
            ),
